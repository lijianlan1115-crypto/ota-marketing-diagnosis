from marketing_diagnosis.ctrip_report_v59 import build_html
from marketing_diagnosis.ctrip_user_profile_report_v59 import donut_svg
...
def test_report_uses_user_profile_chart_template_without_zero_bucket():
    item = build_user_profile_item(profile_rows())
    output = build_html(
        {
            "hotel_name": "测试酒店",
    ...
    assert "CTRIP_USER_PROFILE_V59" in output
    assert "ctrip-profile-v59" in output
