...
from marketing_diagnosis.ctrip_user_profile_report_v59 import STYLE as PROFILE_STYLE
from marketing_diagnosis.ctrip_user_profile_report_v59 import card as profile_card
...
def build_html(result: dict[str, Any]) -> str:
    """Generate the Ctrip report with the item-04 user-profile chart template."""
