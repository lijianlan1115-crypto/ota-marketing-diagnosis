...
SPECS = (
    ...
    (8, "信息完整度", 4, "当前值", "展示携程信息完整度及达标结果。", "ctrip_ota_promotion_status.activity_code=information_completeness", ("信息完整度", "完整度结果")),
    (9, "推广数据：金字塔", 8, "近30天", "展示投入、曝光、点击、订单、订单金额和ROI。", "ctrip_ota_promotion_performance_30d", ("推广投入", "推广曝光", "推广点击", "推广订单", "推广订单金额", "ROI")),
